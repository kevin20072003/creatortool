...
if (!$category) {
    ...
    echo '<main class="container section"><h1>Category not found</h1><p><a class="btn-secondary" href="/tools">View all tools</a></p></main>';
    render_footer();
    exit;
}
...
<main class="container section">
  <p class="muted"><a href="/">Home</a> / <a href="/tools">Tools</a></p>

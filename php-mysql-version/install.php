...
$schema = [
    ...
    "CREATE TABLE IF NOT EXISTS analytics_events (id INT AUTO_INCREMENT PRIMARY KEY, type VARCHAR(80), path VARCHAR(255), entity_slug VARCHAR(190), device VARCHAR(50), referrer TEXT, created_at DATETIME DEFAULT CURRENT_TIMESTAMP)",
